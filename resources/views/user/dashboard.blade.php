...
@endphp
<x-portal-shell title="Dashboard Pengguna" mode="user">
                <section class="space-y-4">
                    <div class="flex justify-between items-end">
                        <div>
                            <h1 class="text-3xl font-bold tracking-tight text-on-surface">Selamat Datang, {{ $displayName }}</h1>
                            <p class="text-x text-on-surface-variant mt-2">Sistem validasi konten resmi pemerintah.</p>
                        </div>
                    </div>
                    ...
                    <div class="relative bg-surface-container-lowest rounded-xl max-w-3xl w-full p-10 shadow-2xl space-y-6">
                        ...
                        <div class="rounded-2xl border border-outline-variant/30 bg-surface-container-low p-5">
                            ...
                            @else
                                ...
                                <div class="mt-4 flex flex-wrap gap-3">
                                    <a href="{{ route('user.official.index') }}" class="inline-flex items-center gap-2 rounded-full border border-outline-variant/30 px-5 py-3 text-sm font-bold text-on-surface hover:bg-surface-container-high transition">
                                        <span class="material-symbols-outlined text-base">verified</span>
                                        Buka daftar konten resmi
                                    </a>
                                </div>
                            @endif
                        </div>
