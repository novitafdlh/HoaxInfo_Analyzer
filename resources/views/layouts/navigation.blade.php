            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @if (Auth::user()->role === 'user')
                    <div class="me-4 flex items-center gap-2">
                        ...
                        <x-nav-link :href="route('user.validation-results')" :active="request()->routeIs('user.validation-results')">
                            {{ __('Hasil Validasi') }}
                        </x-nav-link>
                    </div>
                @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if (Auth::user()->role === 'user')
                ...
                <x-responsive-nav-link :href="route('user.validation-results')" :active="request()->routeIs('user.validation-results')">
                    {{ __('Hasil Validasi') }}
                </x-responsive-nav-link>
            @endif
        </div>
